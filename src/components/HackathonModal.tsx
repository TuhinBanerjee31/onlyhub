...
export const HackathonModal: React.FC<HackathonModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/70 backdrop-blur-sm">
      ...
      {/* Modal Surface */}
      <div className="relative w-full max-w-2xl max-h-[90vh] bg-white dark:bg-neutral-900 rounded-2xl shadow-2xl border border-neutral-200 dark:border-neutral-800 overflow-hidden flex flex-col z-10">
        ...
        <div className="relative w-full h-52 sm:h-60 bg-neutral-100 dark:bg-neutral-800 shrink-0 overflow-hidden">
          ...
          <button
            type="button"
            onClick={onClose}
            className="absolute top-4 right-4 w-9 h-9 rounded-full bg-black/70 hover:bg-black text-white flex items-center justify-center transition-all z-20"
          >
            <X className="w-4 h-4" />
          </button>
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1 text-black dark:text-white">
          {/* Prize pool banner */}
          {hackathon.prizePool && (
            <div className="flex items-center justify-between p-4 rounded-xl bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700">
          ...
          <div className="flex items-center gap-2 flex-wrap pt-1">
            ...
            <a
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 text-xs font-semibold text-black dark:text-white transition-colors"
            >
        ...
        <div className="p-5 border-t border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 flex items-center justify-between gap-3">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-6 py-2.5 rounded-full bg-black text-white dark:bg-white dark:text-black hover:opacity-90 font-bold text-xs transition-all shadow-md"
          >
